...
<form>
	...
	<table id="box" align="center" width="603" border="0" cellpadding="0" cellspacing="0">
	  ...
	  <tr>
		...
		<tr>	
			<td id="list"><table width="100%" border="0" cellspacing="0" cellpadding="0">
	          ...
	          <tr id="writer">
	            <td height="25" align="center">글쓴이</td>
	  ...
	  <tr>
		...
		<img src="/reboard/images/delete_btn.gif" width="61" height="20"> <a href="list.html"><img src="/reboard/images/list_btn.gif" width="61" height="20" border="0"></a> </td>
	  </tr>
	  <tr>
	    <td height="1" bgcolor="#CCCCCC"></td>
	  </tr>
