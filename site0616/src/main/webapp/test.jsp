...
<body>
	<pre>
		앞으로는 자바 코드안에 DBMS에 대한 접속 정보가 없기때문에 
		현재 사용중인 웹 서버가 제공하는 JNDI(이름으로 자원을 찾을 수 있는 기법)을 이용하여서 커넥션을 취득하자.
	</pre>
	<%
		...
		//이 시점부터는 커넥션 풀링 객체를 보유한 것이다.
		
		Connection con =ds.getConnection();//풀로부터 커넥션 한개를 대여
